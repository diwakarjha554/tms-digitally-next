    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-linear-to-br from-blue-600 to-indigo-600 rounded flex items-center justify-center">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-8">
            <span className="px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded font-medium text-sm">
              Next.js 15
            </span>
            <span className="px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded font-medium text-sm">
              TypeScript
            </span>
            <span className="px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded font-medium text-sm">
              Prisma ORM
            </span>
            <span className="px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300 rounded font-medium text-sm">
              PostgreSQL
            </span>
            <span className="px-4 py-2 bg-pink-100 dark:bg-pink-900/30 text-pink-800 dark:text-pink-300 rounded font-medium text-sm">
              NextAuth.js
            </span>
            <span className="px-4 py-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 rounded font-medium text-sm">
              Tailwind CSS
            </span>
          </div>
        </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="p-6 bg-linear-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded border border-purple-200 dark:border-purple-700">
            ...
            <div className="p-6 bg-linear-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded border border-blue-200 dark:border-blue-700">
            ...
            <div className="p-6 bg-linear-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded border border-green-200 dark:border-green-700">
            ...
            <div className="p-6 bg-linear-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 rounded border border-indigo-200 dark:border-indigo-700">
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded p-6 border border-gray-200 dark:border-gray-700">
      ...
      <section id="tech-stack" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-900/50 rounded border border-gray-200 dark:border-gray-700">
        ...
        <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <div className="bg-gray-900 dark:bg-black text-gray-100 p-4 rounded text-sm font-mono overflow-x-auto">
            ...
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <div className="mt-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 p-4 rounded text-sm">
...
NEXTAUTH_URL="http://localhost:3000"`}
            ...
            {/* Default Credentials */}
            <div className="bg-linear-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-700 p-6 rounded">
      ...
      <section id="database" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="bg-gray-50 dark:bg-gray-900/50 p-6 rounded mb-6 border border-gray-200 dark:border-gray-700">
...
└─────────────────┘         └──────────────────┘
        ...
        └──────────►│ userId (FK)      │ │ id (PK)      │
         assignee   │ projectId (FK)   │ │ title        │
          ...
          <div className="mt-6 bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded border border-indigo-200 dark:border-indigo-700">
      ...
      <section id="deployment" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-6">
            {/* Vercel Deployment */}
            <div className="border-2 border-blue-200 dark:border-blue-700 rounded p-6 bg-blue-50 dark:bg-blue-900/20">
            ...
            {/* Docker Deployment */}
            <div className="border-2 border-gray-200 dark:border-gray-700 rounded p-6 bg-gray-50 dark:bg-gray-900/20">
      ...
      <section id="api" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-800 rounded shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            {/* Auth Endpoints */}
            <div className="border border-gray-200 dark:border-gray-700 rounded p-4 bg-gray-50 dark:bg-gray-900/20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-700 dark:to-indigo-700 rounded p-12 text-center shadow-2xl text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/login"
              className="px-8 py-4 bg-white/20 backdrop-blur text-white rounded hover:bg-white/30 transition-all font-semibold text-lg border-2 border-white/50"
            >
              Sign In
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-8 h-8 bg-linear-to-br from-blue-600 to-indigo-600 rounded flex items-center justify-center">
