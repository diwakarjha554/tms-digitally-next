...
export default function EditTaskModal({ task, members, onClose, onTaskUpdated }: EditTaskModalProps) {
  const [loading, setLoading] = useState(false);
  const [taskStatus, setTaskStatus] = useState<'TODO' | 'IN_PROGRESS' | 'DONE'>(task.status);
  const [taskPriority, setTaskPriority] = useState<'LOW' | 'MEDIUM' | 'HIGH'>(task.priority);
